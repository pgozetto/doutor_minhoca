...
const humus = [
  { name: "Húmus Puro", tag: "", image: "/images/humus-padrao.png", sizes: "Embalagens: 1 kg · 5 kg · 10 kg · 25 kg", description: "Húmus natural, peneirado e pronto para uso. Melhora a estrutura do solo e fornece matéria orgânica de forma equilibrada.", uses: ["Hortas e canteiros", "Vasos e jardins", "Preparo de substratos"] },
  { name: "Húmus peletizado", tag: "Sem cheiro, baixa umidade", image: "/images/humus-peletizado.png", sizes: "Embalagem: 800 gramas", description: "Formato compacto, fácil de dosar e armazenar. Liberação gradual para uma adubação organizada e sem desperdício.", uses: ["Plantas de interior", "Mudas e transplantes", "Jardinagem profissional"] },
];

const species = [
  { name: "Gigante-africana", latin: "Eudrilus eugeniae", image: "/images/minhoca-gigante-africana.png", uses: "Pescaria.", orders: ["100 un. — R$ 120", "200 un. — R$ 220", "300 un. — R$ 300", "500 un. — R$ 450", "1.000 un. — R$ 800"] },
  { name: "Vermelha-da-califórnia", latin: "Eisenia fetida", image: "/images/minhoca-vermelha-california.png", uses: "Produção de húmus.", orders: ["250 un. — R$ 80", "500 un. — R$ 125", "1.000 un. — R$ 230", "2.000 un. — R$ 440"] },
  { name: "Aninha-verde", latin: "Dichogaster annae", image: "/images/minhoca-aninha-verde.png", uses: "Alimentação de répteis, pássaros, peixes de água doce ou salgada.", orders: ["100 un. — R$ 110", "200 un. — R$ 220"] },
  { name: "Dama-cheirosa", latin: "Perionyx excavatus", image: "/images/minhoca-dama-cheirosa.png", uses: "Aves recém-nascidas e peixes de pequeno porte.", orders: ["100 un. — R$ 100", "200 un. — R$ 200"] },
];
